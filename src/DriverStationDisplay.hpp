...
public:
    ...
    static DriverStationDisplay<T>* getInstance(uint16_t dsPort);
    ...
    void addAutonMethod(const std::string& methodName, void (T::*function)(),
                        T* object);
...
namespace DS {
enum StatusLight { active, standby, inactive };
...
public:
    ...
    static sf::UdpSocket& getInstance(uint16_t portNumber = 0);
