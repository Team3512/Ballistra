...
DriveTrain::DriveTrain()
    : TrapezoidProfile(maxWheelSpeed, 3.f), m_settings("RobotSettings.txt") {
    m_settings.update();
    ...
    m_rightGrbx->setDistancePerPulse(((3.14159265 * 10.16) / 360.0) * 1.0 /
                                     3.0);
...
void DriveTrain::setLeftManual(float value) { m_leftGrbx->PIDWrite(value); }

void DriveTrain::setRightManual(float value) { m_rightGrbx->PIDWrite(value); }

double DriveTrain::getLeftDist() { return m_leftGrbx->getDistance(); }

double DriveTrain::getRightDist() { return m_rightGrbx->getDistance(); }

double DriveTrain::getLeftRate() { return m_leftGrbx->getRate(); }

double DriveTrain::getRightRate() { return m_rightGrbx->getRate(); }

double DriveTrain::getLeftSetpoint() { return m_leftGrbx->getSetpoint(); }

double DriveTrain::getRightSetpoint() { return m_rightGrbx->getSetpoint(); }
...
bool DriveTrain::getGear() const { return m_leftGrbx->getGear(); }
void DriveTrain::setDefencive(bool defencive) { m_isDefencive = defencive; }
