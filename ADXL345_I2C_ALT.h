...
#ifndef __ADXL345_I2C_ALT_h__
#define __ADXL345_I2C_ALT_h__
 ...
 */
class ADXL345_I2C_ALT : public SensorBase
{
protected:
	//static const uint8_t kAddress = 0xA6;
...
public:
	explicit ADXL345_I2C_ALT(uint8_t moduleNumber, DataFormat_Range range=kRange_2G);
	virtual ~ADXL345_I2C_ALT();
